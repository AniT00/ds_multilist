...
public:
  ...
  size_t levelSize(size_t level) { return m_level_sizes[level]; }
  ...
  void insert(const T& v, const T& after_elem, bool is_child = false)
  {
...
private:
  ...
  Node* find_branch_of(const T& v, Node* root = nullptr)
  {
    find(v, root, true;)
  }

  void push_child(Node* node, const T& v)
  {
  ...
  void print(std::ostream& os, size_t level, Node* n = nullptr) const
  {
